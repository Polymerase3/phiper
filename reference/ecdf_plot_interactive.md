...
#>                    - pop_k_min: 1
#>                    - paired: FALSE
#> [14:59:18] INFO  ranks resolved
#>                    - - available: peptide_id
#> [14:59:18] INFO  grouping universes
#>                    - - per-column only: group
#> [14:59:18] INFO  computing cohort sizes (n) per universe
#> [14:59:18] INFO  computing presence per sample via k-of-n rule
#> [14:59:18] INFO  counting present samples per feature (pop, non-paired)
#> [14:59:18] INFO  fdr accounting
...
#> [14:59:19] INFO  building pairwise comparisons
#> [14:59:20] OK    materialized duckdb table
#>                    - name: ph_prev_20260328_145919
#>                    - computing p-values (fisher-only); then fdr per rank (bh /
#>                      wbh)
#> [14:59:20] OK    prevalence_compare (per-rank fdr) - done
#>                  -> elapsed: 2.469s
