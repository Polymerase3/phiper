...
#> [09:29:17] INFO  preparing distance labels and metadata.
#> Warning: [09:29:17] WARN  column `subject_id` found in `ps`, but `subject_col` is NULL;
#>                  repeated-measures stratification is disabled.
#> [09:29:17] INFO  building metadata from `ps`.
#> [09:29:17] INFO  filtering samples with missing grouping variables.
#> [09:29:17] INFO  subsetting distance matrix to complete cases.
#> [09:29:17] INFO  preparing global permanova model.
#> [09:29:17] INFO  running global permanova
#>                    - model: d_resp ~ group
#> [09:29:17] INFO  running pairwise permanova contrasts.
