...
# Covers plot_alpha() and plot_alpha_interactive()
...
# ===========================================================================
# plot_alpha() — basic returns
# ===========================================================================

testthat::test_that("plot_alpha returns ggplot for grouped data frame", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

testthat::test_that("plot_alpha returns ggplot when group_col=NULL (single box)", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = NULL)
  testthat::expect_s3_class(p, "ggplot")
})

# ===========================================================================
# plot_alpha() — all five metrics produce a valid plot
# ===========================================================================

testthat::test_that("plot_alpha: shannon_diversity metric", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "shannon_diversity", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

testthat::test_that("plot_alpha: simpson_diversity metric", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "simpson_diversity", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

testthat::test_that("plot_alpha: pielou_evenness metric", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "pielou_evenness", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

testthat::test_that("plot_alpha: berger_parker_dominance metric", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "berger_parker_dominance", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

# ===========================================================================
# plot_alpha() — facet_by_rank with multiple ranks
# ===========================================================================

testthat::test_that("plot_alpha: facet_by_rank=TRUE with 2 ranks", {
...
testthat::test_that("plot_alpha: facet_by_rank=FALSE with 2 ranks", {
  df <- .make_plot_df_multirank()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             facet_by_rank = FALSE)
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: group_col=NULL + facet_by_rank with multiple ranks", {
  df <- .make_plot_df_multirank()
  p  <- plot_alpha(df, metric = "richness", group_col = NULL,
                             facet_by_rank = TRUE)
  testthat::expect_s3_class(p, "ggplot")
...
# ===========================================================================
# plot_alpha() — filter_groups and filter_ranks
# ===========================================================================

testthat::test_that("plot_alpha: filter_groups retains only specified groups", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             filter_groups = "A")
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: filter_ranks retains only specified rank", {
  df <- .make_plot_df_multirank()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
...
# ===========================================================================
# plot_alpha() — custom_colors (named and unnamed)
# ===========================================================================

testthat::test_that("plot_alpha: named custom_colors respected", {
  df     <- .make_plot_df()
...
testthat::test_that("plot_alpha: unnamed custom_colors (recycled)", {
  df     <- .make_plot_df()
  p      <- plot_alpha(df, metric = "richness", group_col = "group",
...
# ===========================================================================
# plot_alpha() — y_range, x_order, x_labels, x_tickangle, show_grids
# ===========================================================================

testthat::test_that("plot_alpha: y_range applied (grouped)", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             y_range = c(0, 100))
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: y_range applied (ungrouped)", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = NULL,
                             y_range = c(0, 100))
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: x_order reorders levels", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             x_order = c("B", "A"))
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: factor group_col preserves level order", {
  df       <- .make_plot_df()
...
testthat::test_that("plot_alpha: x_labels applied", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
...
testthat::test_that("plot_alpha: x_tickangle != 0", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             x_tickangle = 45)
  testthat::expect_s3_class(p, "ggplot")
...
testthat::test_that("plot_alpha: show_grids=FALSE", {
  df <- .make_plot_df()
  p  <- plot_alpha(df, metric = "richness", group_col = "group",
                             show_grids = FALSE)
  testthat::expect_s3_class(p, "ggplot")
...
# ===========================================================================
# plot_alpha() — input from a phip_alpha_diversity list
# ===========================================================================

testthat::test_that("plot_alpha: accepts phip_alpha_diversity list", {
  df  <- .make_plot_df()
  lst <- list(group = df)
  ...
  p   <- plot_alpha(lst, metric = "richness", group_col = "group")
  testthat::expect_s3_class(p, "ggplot")
})

testthat::test_that("plot_alpha: interaction_only=TRUE selects interaction table", {
  df_grp   <- .make_plot_df()
...
testthat::test_that("plot_alpha: interaction_only=TRUE falls back to separator-match", {
...
testthat::test_that("plot_alpha: interaction_only=TRUE errors when no table found", {
  df  <- .make_plot_df()
  lst <- list(group = df)
  class(lst) <- c("phip_alpha_diversity", "list")
  attr(lst, "group_cols") <- c("group", "timepoint")
  testthat::expect_error(
    plot_alpha(lst, metric = "richness", group_col = "group",
                         interaction_only = TRUE),
...
# ===========================================================================
# plot_alpha() — error paths
# ===========================================================================

testthat::test_that("plot_alpha: errors when metric column missing", {
...
testthat::test_that("plot_alpha: errors when group_col missing", {
  df <- .make_plot_df()
  testthat::expect_error(
    plot_alpha(df, metric = "richness", group_col = "nonexistent"),
    regexp = "(?i)group"
  )
})

testthat::test_that("plot_alpha: warns and continues when rank_col missing", {
...
# ===========================================================================
# plot_alpha() — significance brackets (show_significance=TRUE)
# ===========================================================================

testthat::test_that("plot_alpha: show_significance=TRUE, no sig pairs -> no error", {
  df  <- .make_plot_df()
...
testthat::test_that("plot_alpha: show_significance=FALSE skips brackets", {
  df  <- .make_plot_df()
  sig <- compute_alpha_significance(df, group_col = "group", metric = "richness")
  p   <- plot_alpha(df, metric = "richness", group_col = "group",
...
# ===========================================================================
# plot_alpha_interactive() — basic sanity
# ===========================================================================
...
testthat::test_that("plot_alpha_interactive: all metrics accepted", {
  ...
  for (m in c("richness", "shannon_diversity", "simpson_diversity",
    ...
    p <- plot_alpha_interactive(df, metric = m, group_col = "group")
    testthat::expect_true(inherits(p, "plotly") || inherits(p, "htmlwidget"),
...
testthat::test_that("plot_alpha_interactive: interaction_only=TRUE", {
  ...
  attr(lst, "group_cols")      <- NULL
  attr(lst, "interaction_sep") <- " * "
  p <- plot_alpha_interactive(lst, metric = "richness",
                                         group_col = "group",
                                         interaction_only = TRUE)
  testthat::expect_true(inherits(p, "plotly") || inherits(p, "htmlwidget"))
})
